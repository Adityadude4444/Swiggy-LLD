            ...
            switch (choice) {
                    ...
                    if (cart.getTotalAmount() < 500) {
                        ...
                        for (Hotel hotel : hotels) {
                            double distance = Math.sqrt(
                                    Math.pow(userX - hotel.getX(), 2) + Math.pow(userY - hotel.getY(), 2));
                        ...
                        if (nearestHotel != null) {
                            System.out.println("Nearest hotel is " + nearestHotel.getName() + " located at ("
                                    + nearestHotel.getX() + ", " + nearestHotel.getY() + ").");
                ...
                case 5:
                    if (isOrderPlaced && assignedDriver != null) {
                        System.out.println(
                                "Driver " + assignedDriver.getName()
                                        + " is en route. Confirm delivery once you receive your order (type 'yes'):");
